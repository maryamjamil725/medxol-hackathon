			...
			<div class="row">
				...
				<div class="col-lg-6 intro_col">
					<div class="intro_form_container">
                        ...
                        <form action="Services12.php" method="post" class="intro_form" id="intro_form">
<!--                        <form action="ServicesSuccess.php" method="post" class="intro_form" id="intro_form">-->
							
                            
                            <div class="d-flex flex-row align-items-start justify-content-between flex-wrap">
                                <input type="text" id="datepicker" id="date" name="date" class="intro_input datepicker" placeholder="Date" required="required">
<!--								<input type="text" class="intro_input" placeholder="Date" required="required">-->
								<input type="time" class="intro_input" id="time" name="time" placeholder="Time" required="required">
								
								<select id="services" name="services" class="intro_select intro_input" required>
									<option disabled="" selected="" value="">Services</option>
									<option value="HouseKeeping">HouseKeeping </option>
                                    <option value="Companionship">Companionship</option>
                                    <option value="Personal Care & Medical Lab">Personal Care &amp; Medical Lab</option>
                                    <option value="Meals & Transportation">Meals &amp; Transportation</option>
